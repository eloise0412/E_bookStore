    ...
    data(){  
        return{
            ...
            products: [
                ...
                { name:'狗勾的行為強化',category:"自然科普", price:320,id:16,author:'多諾倫爾提爾',press:'出版社:大石出版',date:'出版日期:2024/8月',translator:'譯者:池塘的鴨',introduction:'狗狗的教育方式跟貓咪不一樣...' , cover: "/E_bookStore/img/書本封面-16.jpg",type: 'ebook'},
